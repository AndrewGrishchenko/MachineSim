...
private:
    ...
    const FunctionSignature* findReservedFunction(const std::string& name,
    ...
    const std::string write_char =
        "write_char:\n"
        "  sta output_addr\n"
        "  ret\n\n";

    const std::string write_int =
        "write_int:\n"
        "  st read_int_val\n"
        "  cmp const_0\n"
        "  jz write_int_zero\n"
