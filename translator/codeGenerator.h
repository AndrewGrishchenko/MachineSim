...
class CodeGenerator : ASTVisitor {
    ...
    private:
        ...
        const std::string interrupts = "default_interrupt:\n"
                                       "  iret\n"
                                       "input_interrupt:\n"
                                       "  lda input_addr\n"
                                       "  st token\n"
        ...
        const std::string read_char = "read_char:\n"
                                      "  ei\n"
                                      "  ld token\n"
                                      "  jz read_char\n"
                                      "  di\n"
        ...
        const std::string write_to_buf = "write_to_buf:\n"
                                         "  push\n\n"
                                         "  ldi input_buffer\n"
                                         "  add input_buffer_i\n"
                                         "  st temp_right\n\n"
        ...
        const std::string read_string = "read_string:\n"
                                        "  ldi input_buffer\n"
                                        "  add input_buffer_i\n"
                                        "  st input_ptr\n"
                                        "read_string_do:\n"
        ...
        const std::string read_arr = "read_arr:\n"
                                     "  ldi input_buffer\n"
                                     "  add input_buffer_i\n"
                                     "  st input_ptr\n\n"                      
                                     "  ldi 0\n"
        ...
        const std::string write_char = "write_char:\n"
                                       "  sta output_addr\n"
                                       "  ret\n\n";
        ...
        const std::string write_arr = "write_arr:\n"
                                      "  st input_ptr\n\n"
                                      "  lda input_ptr\n"
                                      "  jz write_arr_ret\n"
                                      "  call write_int\n\n"
        ...
        const std::string arr_size = "arr_size:\n"
                                     "  st input_ptr\n\n"
                                     "  ldi 0\n"
                                     "  st write_i\n"
                                     "arr_size_do:\n"
